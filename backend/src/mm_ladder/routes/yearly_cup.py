...
@router.post("/", response_model=YearlyCupRead, status_code=http_status.HTTP_201_CREATED)
...
@router.put("/{cup_id}", response_model=YearlyCupRead)
...
@router.patch("/{cup_id}", response_model=YearlyCupRead)
...
@router.delete("/{cup_id}", status_code=http_status.HTTP_204_NO_CONTENT)
